...
export function NewNoteCard() {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className='rounded-md flex text-left flex-col bg-slate-700 p-5 gap-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 outline-none focus-visible:ring-2 focus-visible:ring-lime-400'>
